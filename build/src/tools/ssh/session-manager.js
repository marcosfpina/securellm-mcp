...
export class SessionManager {
    ...
    connectionManager;
    tunnelManager;
    constructor(dbPath, connectionManager, tunnelManager) {
     ...
     */
    calculateBackoff(attempt, baseMs, strategy) {
    ...
    async saveSessionState(sessionId) {
      ...
      WHERE session_id = ?
    `).run(JSON.stringify(sessionData), sessionData.last_active, sessionId);
     ...
     */
    saveResource(sessionId, type, config) {
        this.db.prepare(`
     ...
     */
    async getPortForwardConfigs(connectionId) {
     ...
     */
    async getJumpChainConfig(connectionId) {
